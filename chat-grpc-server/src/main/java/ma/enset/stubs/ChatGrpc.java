...
public final class ChatGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ma.enset.stubs.Conversation.ChatMessage,
      ma.enset.stubs.Conversation.ChatMessage> getSendMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendMessage",
      requestType = ma.enset.stubs.Conversation.ChatMessage.class,
      responseType = ma.enset.stubs.Conversation.ChatMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ma.enset.stubs.Conversation.ChatMessage,
      ma.enset.stubs.Conversation.ChatMessage> getSendMessageMethod() {
    io.grpc.MethodDescriptor<ma.enset.stubs.Conversation.ChatMessage, ma.enset.stubs.Conversation.ChatMessage> getSendMessageMethod;
      ...
      synchronized (ChatGrpc.class) {
        if ((getSendMessageMethod = ChatGrpc.getSendMessageMethod) == null) {
          ChatGrpc.getSendMessageMethod = getSendMessageMethod = 
              io.grpc.MethodDescriptor.<ma.enset.stubs.Conversation.ChatMessage, ma.enset.stubs.Conversation.ChatMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Chat", "SendMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.enset.stubs.Conversation.ChatMessage.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ma.enset.stubs.Conversation.ChatMessage,
      ma.enset.stubs.Conversation.ChatMessage> getReceiveMessageMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.enset.stubs.Conversation.ChatMessage,
      ma.enset.stubs.Conversation.ChatMessage> getReceiveMessageMethod() {
    io.grpc.MethodDescriptor<ma.enset.stubs.Conversation.ChatMessage, ma.enset.stubs.Conversation.ChatMessage> getReceiveMessageMethod;
  ...
  public static abstract class ChatImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendMessage(ma.enset.stubs.Conversation.ChatMessage request,
        io.grpc.stub.StreamObserver<ma.enset.stubs.Conversation.ChatMessage> responseObserver) {
      asyncUnimplementedUnaryCall(getSendMessageMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<ma.enset.stubs.Conversation.ChatMessage> receiveMessage(
        io.grpc.stub.StreamObserver<ma.enset.stubs.Conversation.ChatMessage> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ma.enset.stubs.Conversation.ChatMessage,
                ma.enset.stubs.Conversation.ChatMessage>(
  ...
  public static final class ChatBlockingStub extends io.grpc.stub.AbstractStub<ChatBlockingStub> {
    ...
    /**
     */
    public ma.enset.stubs.Conversation.ChatMessage sendMessage(ma.enset.stubs.Conversation.ChatMessage request) {
  ...
  public static final class ChatFutureStub extends io.grpc.stub.AbstractStub<ChatFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ma.enset.stubs.Conversation.ChatMessage> sendMessage(
        ma.enset.stubs.Conversation.ChatMessage request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_MESSAGE:
          serviceImpl.sendMessage((ma.enset.stubs.Conversation.ChatMessage) request,
              (io.grpc.stub.StreamObserver<ma.enset.stubs.Conversation.ChatMessage>) responseObserver);
          break;
        default:
  ...
  private static abstract class ChatBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ma.enset.stubs.Conversation.getDescriptor();
    }
